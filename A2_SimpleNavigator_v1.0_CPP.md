...
![SimpleNavigator](assets/img_1456.png)
...
![konigsberg-map](assets/img_3284.png)

![simple-konigsberg-map](assets/img_5865.png)
...
![konigsberg-graph](assets/img_9913.png)
...
![not-orient-graph](assets/img_1231.png)
...
![linked-graph](assets/img_5905.png)

- *Несвязный* — в графе отсутствует путь хотя бы между двумя его вершинами.

![not-linked-graph](assets/img_6565.png)
...
![tree](assets/img_6337.png)

***Остовное дерево (остов)*** — это подграф данного графа, содержащий все его вершины и являющийся деревом. Рёбра графа, не входящие в остов, называются хордами графа относительно остова.

![spanning-tree](assets/img_1184.png)
