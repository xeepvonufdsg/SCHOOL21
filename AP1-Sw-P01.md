# Project Team 01 — Swift\_Bootcamp

Резюме: в этом командном проекте тебе предстоит разработать консольное игровое roguelike-приложение на языке программирования Swift с использованием библиотеки curses (в версии curses для Swift) в духе классической игры Rogue 1980 года разработки.
...
![RogueMap](assets/img_3408.png)

![Dungeon](assets/img_2208.png)
...
- должно быть реализовано на языке Swift версии 5.10;
