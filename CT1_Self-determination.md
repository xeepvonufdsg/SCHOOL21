...
1.  [Chapter I](https://platform.21-school.ru/project/73030/task#chapter-i)
    
    1.1. [Preamble](https://platform.21-school.ru/project/73030/task#preamble)
2.  [Chapter II](https://platform.21-school.ru/project/73030/task#chapter-ii)
    
    2.1. [General rules](https://platform.21-school.ru/project/73030/task#general-rules)
3.  [Chapter III](https://platform.21-school.ru/project/73030/task#chapter-iii)
    
    3.1. [Career priorities](https://platform.21-school.ru/project/73030/task#the-wheel-of-career-priorities)
    
    3.2. [Career goal](https://platform.21-school.ru/project/73030/task#setting-career-goal)
    
    3.2. Career trajectory
4.  [Chapter IV](https://platform.21-school.ru/project/73030/task#chapter-iv)
    
    [Task](https://platform.21-school.ru/project/73030/task#task)
5.  [Chapter V](https://platform.21-school.ru/project/73030/task#chapter-v)

## Chapter I

![Иллюстрация к проекту](school-21/658c50f2-d434-43a2-af2e-7f433e842cd0.jpg)
...
![Колеса карьерных приоритетов](school-21/69e35d1e-86c3-49a8-a94a-498cbef5d196.png)
...
|---|---|---|---|
|To become a CTO in a startup in 5 years and earn 4,000 - 4,500 USD.|Now I'm a student at School 21. I know JS and use React library. I have a relatively small student portfolio.|\- Complete the training to the end.
\- Get a job first in a large company to work with a mentor/manager so I can learn from experience
\- Possibly receive additional training in team management
\- Constantly improve my skills
\- Build a portfolio
\- Solve algorithms|1\. Complete the training
2\. Create a resume and prepare a portfolio
3\. Successfully pass an interview and get a job
4\. Work in a team of developers for the first 2-3 years, be initiative and become a team leader
5\. Become a head of the department in 4-5 years, leave for the startup and become CTO|
...
2.  The second point "B" is your career goal for 5 years ahead. Planning a career beyond 5 years is difficult because the world is changing rapidly now, some professions are dying out and others are being automated, so it's important to follow your direction, develop your skills and stay on track.
3.  The intermediate point between "A" and "B" is 2-3 years.

|Today (point A)|2-3 years|Career goal (point B)
|---|---|---|
5 years|
|At this point, you describe:
\- Your current career status
\- Skills and knowledge you possess
\- Resources available for development|You will fill in this column later, after completing exercises on job analytics and identifying your strengths. Then you will need to write down the action plan that you will be ready to implement to achieve your career goal.|Describe the desired position that you want to take up in 5 years, for example:
_CTO in an educational startup working remotely with a team of 4-5 developers and a salary of 4,500 USD with benefits_.
For each period, you can use the SMART or GROW methodology.|
