...
A maze with "thin walls" is a table of *n* rows by *m* columns size. There may be "walls" between the cells of a table. The table as a whole is also surrounded by "walls".

The following is an example of such a maze: \
![maze](assets/img_7669.png)
...
![cave1](assets/img_8880.png)
![cave2](assets/img_1520.png)
...
- The program must be developed in JavaScript language
- The program code must be located in the src folder
- When writing code it is necessary to follow the Google style
- The program must be built with Makefile which contains standard set of targets for GNU-programs: all, install, uninstall, clean, dvi, dist, tests. Installation directory could be arbitrary, except the building one
- GUI implementation, based on any GUI library for JavaScript
...
Agent training and interaction modules should be developed in JavaScript language without using ready-made reinforcement learning libraries.
