# Project Backend 04 — Swift\_Bootcamp

Резюме: в этом проекте ты научишься добавлять базы данных в веб-приложения на языке **Swift** с использованием **Vapor** и работать с авторизацией.
...
- Опиши подключение к базе данных PostgreSQL с библиотеками [Fluent](https://docs.vapor.codes/fluent/overview/) и драйвером для PostgreSQL от Vapor в файле configure.swift.
- Избавься от класса-хранилища.
- Добавь специальные аннотации для параметров классов, которые необходимо сохранять в базу данных, — id, key.
...
- Создай структуру UserAuthenticator, сделай наследование [BasicAuthenticator](https://docs.vapor.codes/security/authentication/#basic) для защиты от создания запросов неавторизированными пользователями.
