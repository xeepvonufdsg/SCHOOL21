# Project Backend 05 — С#\_Bootcamp

Резюме: в этом проекте ты научишься работать с jwt-авторизацией и расширять возможности веб-приложений на языке **C#** с использованием ASP.NET.
...
- Создай модель JwtResponse, у которой будет тип, accessToken и refreshToken.
...
- Обнови сервис авторизации, который использует UserService, JwtProvider, HttpContext для реализации следующих методов:
