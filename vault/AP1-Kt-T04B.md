# Project Backend 04 — Kotlin\_Bootcamp

Резюме: в этом проекте ты научишься добавлять базы данных в веб-приложения на языке **Kotlin** с использованием Ktor и работать с авторизацией.
...
- Добавь новую функцию-расширение для Application, где описывается подключение к базе данных PostgreSQL с использованием Exposed.
- Добавь в `.../resources/application.conf` подключение новой функции-расширения.
...
- Для каждого endpoint'а используй отдельную функцию-расширение для Route.
- Добавь новые endpoint'ы в routing.
- Установи Authentication в ktor features.
- Опиши в Authentication basic-авторизацию.
