...
![decision_tree_animals](assets/img_9010.png)
...
![iris_dataset](assets/img_1000.png)
...
![ensemble_methods](assets/img_1094.png)
...
![gradient_boosting](assets/img_8429.png)
...
It should support *fit*, *predict\_proba*, and *predict* methods. Also, the maximum depth (max\_depth) must be a parameter of your class. Use the Gini impurity criterion as a criterion for choosing the split.
