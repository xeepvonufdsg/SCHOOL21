...
1.  [Chapter I](https://platform.21-school.ru/project/73032/task#chapter-i)
    
    1.1. [Preamble](https://platform.21-school.ru/project/73032/task#preamble)
2.  [Chapter II](https://platform.21-school.ru/project/73032/task#chapter-ii)
    
    2.1. [General rules](https://platform.21-school.ru/project/73032/task#general-rules)
3.  [Chapter III](https://platform.21-school.ru/project/73032/task#chapter-iii)
...
4.  [Chapter IV](https://platform.21-school.ru/project/73032/task#chapter-iv)
    
    [Задача](https://platform.21-school.ru/project/73032/task#%D0%B7%D0%B0%D0%B4%D0%B0%D1%87%D0%B0)
5.  [Chapter V](https://platform.21-school.ru/project/73032/task#chapter-v)

## Chapter I

![Иллюстрация к проекту](school-21/dcc5a412-1e0d-417f-ae10-588328fad547.jpg)
...
Контактная информация — эта первое, с чем знакомится рекрутер. Казалось бы, какие тут могут ошибки? Однако давай сравним два оформления: ![Контакты](school-21/9f587c20-6cd5-4b29-8739-fe9a18cca124.png)
...
2.  **Почта! Никаких kotletka@, princesska@, kotik@**
    ...
    Давай оставим эти почты для спам-магазинов. Лучше всего указать фамилия\_имя@... Например, malikova\_julia, malikovaj и т. д.
...
Навыки описываются в резюме, исходя из желаемой должности! Как определить, какие навыки писать?
...
Выписывай навыки, исходя из твоего уровня знаний и опыта в порядке приоритетности. И, конечно, не преувеличивай свои скиллы: если ты не работал с каким-либо компонентом или просто отсутствует опыт, то лучше и не указывай его.
...
Если ты работал в крупной компании, то, скорее всего, любой нанимающий HR-менеджер знает эти компании, и такое резюме придает вес к опыту. Если ты работал в малоизвестной фирме, то желательно написать, что выделяет эту компанию, какая сфера ее деятельности. Обычно эту информацию можно найти на сайте самой компании. Возможно, компания — лидер в какой-либо индустрии, работает с крупными клиентами (Сбер, Яндекс и т. д.). Все это можно указать в резюме.
...
-   Всегда указывай опыт работы с последнего (текущего места) к первому твоему опыту. Если у тебя рваный опыт работы — по 3-4 месяца на каждом месте работы, — то можно объединить в проектную деятельность / фриланс.
    
-   Можно не указывать какие-то места и на собеседовании сказать, что был в поиске работы и проходил собеседования. Стандартный поиск работы может занимать от 3 до 6 месяцев — это нормально. Старайся в дальнейшем задерживаться на работе на год-полтора. Потому что те, кто часто меняют место работы, для рекрутера расцениваются как непостоянные или ненадежные люди.
...
5.  Какие мои сильные компетенции? _Чтобы ответить на этот вопрос, посмотри задание по SWOT-анализу._
...
_Должностные обязанности._ Аналитик выполняет следующие должностные обязанности:
...
Этот пункт — самый важный в резюме. Компании-работодателю всегда интересно, каких результатов ты достиг, поэтому желательно их оцифровать. Глаголы, которые помогут тебе описать свои достижения:
...
4.  Участие в интеллектуальном волонтерском проекте или IT-помощь для волонтеров. Ты можешь подать заявку на проект и при успешном отборе выполнить задание и занести его в портфолио (ProCharity).
...
3.  Укажи твои мягкие навыки (софт-скиллы).
    ...
    Только не пиши через запятую: стрессоустойчивый, проактивный, коммуникабельный и т. д. Когда указываешь подобные навыки, возвращайся к своему прошлому опыту. Задай себе вопрос, почему у тебя лидерские качества? Возможно, у тебя был опыт в студенческие годы ведения проектов, за которые ты нес ответственность? Если ты стрессоустойчив? Почему? Какая ситуация/работа способствовала развитию такого навыка?
...
Стандарт резюме — две страницы, желательно основную информацию разместить на первой. Но запомни: неважно, сколько у тебя страниц в резюме, главное, чтобы твое резюме было интересно читать.
...
|---|---|
|1\. Отсутствие достижений в твоем опыте работы|Распиши не только свои обязанности, но и укажи свои KPI. Например:
\- вошел в ТОП-3 лучших студентов курса;
\- являлся наставником для 5+ сокурсников, оказывал помощь в освоении программы обучения;
\- выполнил 30+ учебных проектов.
KPI – это измеримые показатели твоей работы. Эти данные показывают твою эффективность и то, что интересно работодателю.|
...
**Шаг 1.** Проведи анализ компании/вакансии/проекта.
...
**Шаг 3.** Составь сопроводительное письмо, используя структуру:
...
Пример [Сопроводительного письма](https://git.21-school.ru/masters/CT02.ID_886651/-/blob/20/materials/%D0%A1%D0%BE%D0%BF%D1%80%D0%BE%D0%B2%D0%BE%D0%B4%D0%B8%D1%82%D0%B5%D0%BB%D1%8C%D0%BD%D0%BE%D0%B5_%D0%BF%D0%B8%D1%81%D1%8C%D0%BC%D0%BE.pdf). (доступно для скачивания в папке materials -> Сопроводительное\_письмо)
...
Тебе необходимо сделать собственное резюме для вакансии, которую ты отобрал в предыдущем проекте. После того как сделаешь резюме, нужно найти человека на такой же должности, на которую претендуешь, или среди выпускников «Школы 21», и получить обратную связь по резюме.
