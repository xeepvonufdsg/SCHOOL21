# Project Team 01 — Kotlin\_Bootcamp

Резюме: в этом командном проекте тебе предстоит разработать консольное игровое roguelike-приложение на языке программирования Kotlin с использованием библиотеки curses (используй [cinterop](https://kotlinlang.org/docs/native-c-interop.html#platform-libraries) для взаимодействия с библиотекой NCurses для C) в духе классической игры Rogue 1980 года разработки.
...
![RogueMap](assets/img_9124.png)

![Dungeon](assets/img_7828.png)
...
Так, в слое **presentation** необходимо разместить код, который будет организовывать логику отображения на экране пользователя и ввод пользовательских данных. То есть здесь должно быть отражено взаимодействие с компонентами библиотеки NCurses и Domain-уровнем.
...
- должно быть реализовано на языке Kotlin версии 1.6.0;
- должно иметь консольный интерфейс на базе библиотеки NCurses;
...
Реализуй с NCurses рендеринг игры в **presentation**-слое, используя необходимые сущности **domain**.
...
- Для 3D-рендеринга комнат и коридоров используй алгоритм Ray Casting и библиотеку NCurses.
