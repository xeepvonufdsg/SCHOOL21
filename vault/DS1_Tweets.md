...
*Summary:* This project is an introduction to natural language processing: bag of words, TFIDF, stemming, lemmatization,
...
- You will work with the dataset of tweets. The tweets will be labeled as positive, negative, and neutral. That is it. The [source](https://git.21-school.ru/masters/DS1_Tweets.ID_886380/-/blob/6/./datasets/p00_tweets.zip) of the dataset.

> **Note:** You can find the dataset on the project page: "p00\_tweets.zip"
...
![1](assets/img_5493.png)

![2](assets/img_4443.png)
